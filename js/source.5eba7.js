...
module.exports = {"task":"styles-m__task---2dTfq","content":"styles-m__content---39-vZ","toggleTaskCompletedState":"styles-m__toggleTaskCompletedState---12Gjf","actions":"styles-m__actions---1VV1u","toggleTaskFavoriteState":"styles-m__toggleTaskFavoriteState---cX_vG","updateTaskMessageOnClick":"styles-m__updateTaskMessageOnClick---1O57l","off":"styles-m__off---3KD3T","completed":"styles-m__completed---RHetD"};
...
/* harmony import */ var components_Scheduler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(14);
var _dec, _class;
...
const api = {
  ...
  async createTask(newTask) {
    return await this.fetchMediator('POST', {
      message: newTask
    });
  },
...
class Task_Task extends react["PureComponent"] {
  ...
  render() {
    ...
    return react_default.a.createElement("li", {
      className: `${Task_styles_m_default.a.task}${completed ? ' ' + Task_styles_m_default.a.completed : ''}`
...
class Scheduler_Scheduler extends react["Component"] {
  constructor(...args) {
    ...
    this._asyncMediator = async callback => {
      try {
    ...
    this._updateTaskAsync = async updatedTask => {
      ...
      this._asyncMediator(async () => {
        ...
        this.setState({
          tasks: sortTasksByGroup(this._updateTasks(tasks, dataTasks[0]))
        });
      });
    };
    ...
    this._setAllTasksComplete = tasks => {
      return tasks.map(item => {
        return Scheduler_objectSpread({}, item, {
          completed: true
        });
      });
    };
    ...
    this._updateTasks = (tasks, newTask) => {
      return tasks.map(item => {
  ...
  render() {
    ...
    const tasksJSX = tasks.filter(task => {
      return task.message.toLowerCase().includes(tasksFilter);
    }).map(props => react_default.a.createElement(Task_Task, Scheduler_extends({
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.5eba7.js.map